...
class ServiceLoader:
    ...
    def _load_service_file(self, filepath: Path, *, explicit_name: Optional[str] = None) -> None:
        ...
        # Enforce that services which produce output define a logfile
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Tiny subset of the Dinit service manager (start-only).")
